...
_START_SEGMENTS = [
    ('text', "Hi! I'm a Python console calculator. Send me an expression and I'll return the value of the last line."),
    ('text', 'Try (tap to copy):'),
    ('code', '2 + 2'),
    ('text', 'Or a built-in:'),
    ('code', 'math.factorial(20)'),
    ('text', 'Send /help for multi-line programs and imports.'),
]

_HELP_SEGMENTS = [
    ('bold', 'CalcuBot - a Python console calculator'),
    ('text', 'Send an expression; the value of the final line comes back. Tap any example to copy it, then send it on its own.'),
    ('text', 'Basics:'),
    ('code', '2 + 2'),
    ('text', 'Order of operations and functions work:'),
    ('code', '(3.14 * 100) / 2'),
    ('text', 'Built-ins are available:'),
    ('code', 'math.factorial(10)'),
    ('bold', 'Multi-line programs'),
    ('text', "The last line's value is returned:"),
    ('code', 'total = 0\nfor i in range(1, 6):\n    total += i ** 2\ntotal'),
    ('bold', 'Imports'),
    ('text', 'From a math/data allowlist: math, cmath, statistics, fractions, decimal, random, datetime, itertools, functools, operator, collections, re, json, string, bisect, heapq, numbers, array.'),
